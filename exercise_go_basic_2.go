...
func roundCircum(x float64) int {
...
func main() {
	...
	fmt.Printf("Chu vi hinh tron ban kinh %d la: %.6f\n", rad, calculateCircumference(rad)) //Printf nhu trong C
	fmt.Printf("Chu vi hinh tron ban kinh %d khi lam tron thanh dang int la: %d\n", rad, roundCircum(calculateCircumference(rad)))
}
